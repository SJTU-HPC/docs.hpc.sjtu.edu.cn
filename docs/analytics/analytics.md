...
In the future, pulling Shifter images from private repositories or sources other
...
Since the registry is blocked at the border, pushing images to the NERSC registry
