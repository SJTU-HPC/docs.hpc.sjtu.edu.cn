...
| 版本                   | 加载方式                                    | 组件说明                 |
+========================+=============================================+==========================+
| intel-mpi-2021.4.0     | module load intel-oneapi-mpi/2021.4.0       | Intel MPI库              |
|                        | module load intel-oneapi-compilers/2021.4.0 |                          |
+------------------------+---------------------------------------------+--------------------------+
| intel-mpi-2019.4.243   | module load intel-mpi/2019.4.243            | Intel MPI库              |
+------------------------+---------------------------------------------+--------------------------+
| intel-mpi-2019.6.154   | module load intel-mpi/2019.6.154            | Intel MPI库              |
+------------------------+---------------------------------------------+--------------------------+

在使用 intel-mpi 的时候，请尽量保持编译器版本与后缀中的编译器版本一致，如 intel-mpi-2019.4.243/intel-19.0.4 和 intel-19.0.4 。 另外我们建议直接使用Intel全家桶。
