...
| 平台     | 版本     | 调用方式                                       |
+==========+==========+================================================+
| 思源一号 | 20230328 | module load lammps/20230328-intel-2021.4.0-omp |
+----------+----------+------------------------------------------------+
| 思源一号 | 20220324 | module load lammps/20220324-intel-2021.4.0-omp |
+----------+----------+------------------------------------------------+
| 思源一号 | 20210310 | module load lammps/20210310-intel-2021.4.0-omp |
+----------+----------+------------------------------------------------+
| pi 2.0   | 20230328 | module load lammps/20230328-intel-2021.4.0-omp |
+----------+----------+------------------------------------------------+
| pi 2.0   | 20220324 | module load lammps/20220324-oneapi-2021.4.0    |
+----------+----------+------------------------------------------------+
| kunpeng  | 20190605 | module load lammps/bisheng-1.3.3-lammps-2019   |
+----------+----------+------------------------------------------------+
