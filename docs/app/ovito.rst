...
一、在本地电脑的 OVITO 上，远程调用 π集群 上的原子构型文件（推荐）

二、在可视化平台的远程桌面里调用 π集群 上的 OVITO
...
OVITO 需要在 HPC Studio 可视化平台上使用。π集群 登陆节点不支持 OVITO 显示。
