...
| [ Gromacs ](https://docs.hpc.sjtu.edu.cn/application/Gromacs/) |2019.2, 2019.4 ![x86](https://img.shields.io/badge/-x86-green) ![gpu](https://img.shields.io/badge/-gpu-blueviolet)![arm](https://img.shields.io/badge/-arm-yellow) |GROMACS is a versatile package to perform molecular dynamics, i.e. simulate the Newtonian equations of motion for systems with hundreds to millions of particles. It is primarily designed for biochemical molecules like proteins, lipids and nucleic acids that have a lot of complicated bonded interactions, but since GROMACS is extremely fast at calculating the nonbonded interactions (that usually dominate simulations) many groups are also using it for research on non-biological systems, e.g. polymers. |
...
| [ LAMMPS ](https://docs.hpc.sjtu.edu.cn/application/Lammps/) | 20190807 ![x86](https://img.shields.io/badge/-x86-green) ![gpu](https://img.shields.io/badge/-gpu-blueviolet)![arm](https://img.shields.io/badge/-arm-yellow)|(Large-scale Atomic/Molecular Massively Parallel Simulator) a classical molecular dynamics code. |
...
|[ Relion ](https://docs.hpc.sjtu.edu.cn/application/Relion/) |3.0.8 ![gpu](https://img.shields.io/badge/-gpu-blueviolet)| REgularised LIkelihood OptimisatioN (RELION) employs an empirical Bayesian approach to refinement of (multiple) 3D reconstructions or 2D class averages in electron cryomicroscopy.|
