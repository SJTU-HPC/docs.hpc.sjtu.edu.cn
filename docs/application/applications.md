...
商业软件需用户自行获取版权并安装。<br>
<br>
![cpu](https://img.shields.io/badge/-cpu-blue) ![gpu](https://img.shields.io/badge/-gpu-green) ![arm](https://img.shields.io/badge/-arm-yellow) 标签表明软件有 x86、gpu、arm 版本
...
| [ LAMMPS ](https://docs.hpc.sjtu.edu.cn/application/Lammps/) | 20190807 ![cpu](https://img.shields.io/badge/-cpu-blue) ![gpu](https://img.shields.io/badge/-gpu-green)![arm](https://img.shields.io/badge/-arm-yellow)|(Large-scale Atomic/Molecular Massively Parallel Simulator) a classical molecular dynamics code. |
