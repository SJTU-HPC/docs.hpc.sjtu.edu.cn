...
|               | 显存的 V100卡                     |
+---------------+-----------------------------------+
| arm128c256g   | 允许单作业 CPU 核数为              |
|               | 1~12800，每核配比 2G 内存，       |
|               | 节点可共享使用；单节点配置为        |
|               | 128 核，256G 内存                  |
+---------------+-----------------------------------+

64c512g, a100, small, cpu 队列允许的作业运行最长时间为 7 天, arm128c256g 和 dgx2 为 3 天, huge 和 192c6t 为 2天。
