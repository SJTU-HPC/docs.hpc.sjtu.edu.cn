...
==========================   ==========   ========== ==============  =======================================================================  =========================================================
文件系统                      挂载点       裸盘容量    存储介质        在哪些节点访问                                                         是否收费
==========================   ==========   ========== ==============  =======================================================================  =========================================================
Lustre                       /lustre       25 PB      HDD            Pi 2.0集群的登录节点、计算节点；data传输节点                             3 TB以下免费，3 TB 以上收费，和思源存储合并计费

GPFS                         /dssg         10 PB      HDD　　　　　  思源一号集群的登录节点、计算节点；data、sydata传输节点                    3 TB以下免费，3 TB 以上收费，和 Pi2.0 存储合并计费

全闪存文件系统               /scratch      108 TB     NVMe SSD       Pi 2.0、思源一号集群的登录节点、计算节点；data传输节点　　　　　　       不收费

冷存储系统                   /archive      23.5 PB      HDD             data、sydata传输节点                                                  收费
==========================   ==========   ========== ==============  =======================================================================  =========================================================
...
* 冷存储系统：作为 Lustre/GPFS 文件系统的补充，提供大容量、高可用的存储，只能在传输节点访问，主要给用户存放不常用的数据。用户通过 ``cd $ARCHIVE`` 可以跳转到冷存储下自己的目录。
